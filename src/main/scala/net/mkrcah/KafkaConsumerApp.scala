...
object KafkaConsumerApp extends App{
 ...
 // config.set("mongo.input.uri", "mongodb://myUserAdmin:abc123@localhost:27017/test.twitter")
  config.set("mongo.output.uri", "mongodb://127.0.0.1:27017/test.twitter")    
